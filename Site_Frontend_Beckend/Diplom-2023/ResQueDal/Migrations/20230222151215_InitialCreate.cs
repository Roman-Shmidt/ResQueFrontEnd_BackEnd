        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsActiveByDefault = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    IsQueueOpen = table.Column<bool>(type: "bit", nullable: false),
                    IsReservationOpen = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<int>(type: "int", nullable: true),
                    CompanySize = table.Column<int>(type: "int", nullable: false),
                    PlaceInQueue = table.Column<int>(type: "int", nullable: false),
                    EstimatedTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantQueues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantQueues_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RestaurantQueues_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_MainRole",
                table: "AspNetRoles",
                column: "MainRole")
                .Annotation("SqlServer:Clustered", false);

            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_Number",
                table: "AspNetRoles",
                column: "Number",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantQueues_ClientId",
                table: "RestaurantQueues",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantQueues_RestaurantId",
                table: "RestaurantQueues",
                column: "RestaurantId");
